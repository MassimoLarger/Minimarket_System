...
SECRET_KEY = 'django-insecure-q4ifxiinnj(@8abd)#85u%r4@rd4lypem8^0gskj9wbwa(8_w2'
...
SESSION_COOKIE_NAME = 'minimarket_sessionid'

# Configuración del serializador de sesiones
