    ...
    if request.method == 'POST':
        if 'buscar_codigo' in request.POST:
            ...
            try:
                ...
                # Buscar ofertas activas para el producto
                oferta_activa = Oferta.objects.filter(
                    Q(oferta_producto__producto_id=producto) | Q(oferta_vencimiento__producto_id=producto),
                ...
                if oferta_activa:
                    precio_final = precio_final * (1 - oferta_activa.descuento_porcetaje / 100)
                ...
                producto_encontrado = {
                    ...
                    'oferta_aplicada': oferta_activa.tipo_oferta if oferta_activa else None
                }
